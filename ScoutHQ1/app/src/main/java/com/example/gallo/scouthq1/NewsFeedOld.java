...
public class NewsFeedOld extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //background.setOnTouchListener(new OnSwipeTouchListener(){
            public boolean onSwipeRight(){
                Intent myIntent = new Intent(NewsFeedOld.this, SportsSelection.class);
                NewsFeedOld.this.startActivity(myIntent);
                return true;
    ...
    public void onClick(View view) {
        ...
        {
            case R.id.fab:
                Intent newsFeedIntent = new Intent(NewsFeedOld.this, SportsSelection.class);
                NewsFeedOld.this.startActivity(newsFeedIntent);
                break;
