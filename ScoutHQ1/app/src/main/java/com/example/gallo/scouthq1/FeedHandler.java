...
public class FeedHandler extends DefaultHandler {
    private List<FeedSource> rssItemList;
    private FeedSource currentItem;
    ...
    public FeedHandler() {
        ...
        rssItemList = new ArrayList<FeedSource>();
    }

    public List<FeedSource> getRssItemList() {
        return rssItemList;
    }
